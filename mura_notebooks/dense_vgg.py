...
architecture = 'dense_vgg'

main_save_path = "C:/Users/raouf/Desktop/pfe/history/final/"+architecture+"/"
...
for target_category in target_categories:
    ...
    def build_ensemble_model():
        ...
        concat_output = tf.keras.layers.Concatenate(axis=-1)([densenet_base_output, vgg_base_output])
