...
train_dir = "C:/Users/raouf/Desktop/pfe/new_mura/train/XR_ELBOW"
test_dir = "C:/Users/raouf/Desktop/pfe/new_mura/val/XR_ELBOW"
validation_dir = "C:/Users/raouf/Desktop/pfe/new_mura/val/XR_ELBOW"
saveHistoryDirectory = 'C:/Users/raouf/Desktop/pfe/history/mura_to_work/'
...
def build_model(arch):
    ...
    # model.summary()
    model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=learning_rate), loss=loss_function, metrics=["accuracy"])
    return model
...
test_generator = test_datagen.flow_from_directory(validation_dir, target_size=(224, 224), batch_size=batch_size,
                                                  class_mode='categorical')
